...
function ReportPreviewHeader() {
    ...
    const rawReportName = derivedReportName ?? iouReport?.reportName ?? '';
    const reportName = useMemo(() => Parser.htmlToText(rawReportName || action.childReportName || ''), [rawReportName, action.childReportName]);
