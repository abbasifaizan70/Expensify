...
function TextCommentFragment({fragment, styleAsDeleted, reportActionID, styleAsMuted = false, source, style, displayAsGroup, iouMessage = ''}: TextCommentFragmentProps) {
    ...
    return (
        <Text style={[containsOnlyEmojis && styles.onlyEmojisText, styles.ltr, style, (!canUseTouchScreen() || hasHoverSupport()) || !shouldUseNarrowLayout ? styles.userSelectText : styles.userSelectNone]}>
            <ZeroWidthView
                text={text}
