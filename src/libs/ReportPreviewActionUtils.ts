...
import {hasSubmissionBlockingViolations, isFetchingWaypointsFromServer, isPending, isScanning} from './TransactionUtils';
...
function canSubmit(
    ...
    if (transactions?.some((transaction) => isFetchingWaypointsFromServer(transaction))) {
        return false;
    }
